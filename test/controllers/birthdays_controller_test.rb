...
class BirthdaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create birthday" do
    assert_difference('Birthday.count') do
      post birthdays_url, params: { birthday: { birthdate: @birthday.birthdate, firstname: @birthday.firstname, lastname: @birthday.lastname } }
    end
  ...
  test "should update birthday" do
    patch birthday_url(@birthday), params: { birthday: { birthdate: @birthday.birthdate, firstname: @birthday.firstname, lastname: @birthday.lastname } }
