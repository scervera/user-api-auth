module Api
  module V1
    class BirthdaysController < Api::ApplicationController
      ...
      def create
        ...
        respond_to do |format|
          if @birthday.save
            format.html { redirect_to birthday_url(@birthday), notice: "Birthday was successfully created." }
      ...
      def update
        respond_to do |format|
          if @birthday.update(birthday_params)
            format.html { redirect_to birthday_url(@birthday), notice: "Birthday was successfully updated." }
      ...
      private
        ...
        def birthday_params
          params.require(:birthday).permit(:firstname, :lastname, :birthdate)
        end
    end
  end
end
